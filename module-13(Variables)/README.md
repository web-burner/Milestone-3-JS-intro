...
2. variable naming convention : 
    ...
    6. for long name use underscore (_) instead of space. its called snakeCase or use camelCase like one word after start with capital letter
...
1. addition shorthand: 

let num1 = 10;
num1 += 5;
console.log(num1)

2. subtraction shorthand : 

let num1 = 10;
num1 -= 5;
console.log(num1)

3. multiplication shorthand:
